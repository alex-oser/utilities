...
# r: Open subreddit given in argument '1' in Google Chrome
r () { /usr/bin/open -a "/Applications/Google Chrome.app" "https://old.reddit.com/r/$1"; }
...
showa () { alias | /usr/bin/grep --color=always -i -a $@ ; }
